...
public class AccountUtils {
    ...
    public final static String POST_SUCCESS_CODE = "006";
    public final static String POST_SUCCESS_MESSAGE = "Post Uploaded Successfully";


    public final static String EMPTY_TOKEN_CODE = "007";
    public final static String EMPTY_TOKEN_MESSAGE = "Token is Empty or Null";

    public final static String INVALID_TOKEN_CODE = "008";
    public final static String INVALID_TOKEN_MESSAGE = "Token is invalid";


    public final static String BLACKLISTED_TOKEN_CODE = "009";
